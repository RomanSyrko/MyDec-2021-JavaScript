...
for (let item of usersList) {
    ...
    catchPhrase.innerText = `Catch Phrase - ${item.company.catchPhrase}`

    let bs = document.createElement(`div`);
    bs.innerText = `bs - ${item.company.bs}`


    mainDIV.append(id, name, username, email, addresses, phone, website, company)
    addresses.append(street, suite, city, zipcode, geo)
    geo.append(lat, lng)
    ...
    addresses.style.marginLeft = `20px`
    company.style.marginLeft = `20px`
    geo.style.marginLeft = `40px`
}
